...
namespace ProvaPub.Controllers
{
	...
	public class Parte3Controller :  ControllerBase
	{
        ...
        [HttpGet("orders")]
		public IActionResult PlaceOrder(string paymentMethod, decimal paymentValue, int customerId)
		{
            return Ok(_orderService.PayOrder(paymentMethod, paymentValue, customerId));
		}
	}
}
